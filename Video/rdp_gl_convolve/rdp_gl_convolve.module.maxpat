...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"presentation_rect" : [ 82.0, 213.0, 0.0, 0.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "" ],
					"patching_rect" : [ 17.0, 23.0, 150.0, 70.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 17.0, 179.0, 151.0, 22.0 ],
					"style" : "",
					"text" : "rdp_gl_convolve.model #1"
				}
...
, 			{
		...
		"parameters" : 		{
			"obj-4::obj-4" : [ "sum", "Sum", 0 ],
			"obj-4::obj-32" : [ "width", "Width", 0 ],
			"obj-4::obj-2" : [ "height", "Height", 0 ]
		}
,
		"dependency_cache" : [ 			{
				"name" : "rdp_gl_convolve.model.maxpat",
				"bootpath" : "~/Documents/Github_Development_Library/rdp_Jamoma_06/Video/rdp_gl_convolve",
				"type" : "JSON",
				"implicit" : 1
			}
, 			{
