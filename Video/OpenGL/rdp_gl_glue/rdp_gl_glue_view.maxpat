...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 523.5, 123.72876, 50.0, 22.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 228.887177, 30.5, 50.0, 22.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 128.5, 130.5, 50.0, 22.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 103.0, 30.5, 50.0, 22.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 573.5, 127.72876, 144.0, 18.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 176.0, 32.5, 46.0, 18.0 ],
					"style" : "",
					"text" : "Volume:",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 523.5, 152.88562, 81.0, 22.0 ],
					"style" : "",
					"text" : "j.remote fade"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 128.5, 159.5, 107.0, 22.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 185.083328, 130.5, 109.0, 18.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 11.0, 32.5, 88.0, 18.0 ],
					"style" : "",
					"text" : "Playback Rate:",
					"textcolor" : [ 0.878431, 0.878431, 0.858824, 1.0 ]
				}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "", "int", "", "" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 113.5, 272.0, 162.0, 18.0 ],
									"presentation" : 1,
									"presentation_rect" : [ 64.0, 54.277779, 162.0, 18.0 ],
									"rounded" : 20.0,
									"style" : "default",
									"text" : "Jamoma",
									"textjustification" : 0
...
, 							{
								"box" : 								{
									...
									"presentation" : 1,
									"presentation_rect" : [ 4.0, 54.277779, 58.0, 18.0 ],
									"style" : "",
									"text" : "Draw to:",
									"textcolor" : [ 0.878431, 0.878431, 0.858824, 1.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"presentation" : 1,
									"presentation_rect" : [ 0.0, 42.875, 235.774353, 39.0 ],
									"proportion" : 0.39,
									"pt1" : [ 0.49505, 0.86087 ],
									"pt2" : [ 0.5, 0.95 ],
									"rounded" : 0,
...
,
					"patching_rect" : [ 248.0, 286.5, 50.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 248.0, 196.0, 300.0, 70.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 248.0, 392.61438, 25.0, 25.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 248.0, 319.61438, 25.0, 25.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 248.0, 359.61438, 231.0, 22.0 ],
					"style" : "",
					"text" : "j.view @description \"interface for gl_glue\""
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 533.0, 185.0, 512.0, 185.0, 512.0, 107.0, 533.0, 107.0 ],
					"source" : [ "obj-10", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 138.0, 195.0, 118.0, 195.0, 118.0, 119.0, 138.0, 119.0 ],
					"source" : [ "obj-12", 0 ]
				}
