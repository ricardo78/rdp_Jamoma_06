...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"presentation_rect" : [ 116.0, 213.0, 0.0, 0.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					"annotation" : "a model for glow effect",
					"id" : "obj-1",
					"maxclass" : "newobj",
					"numinlets" : 1,
					"numoutlets" : 2,
...
, 			{
		...
		"parameters" : 		{
			"obj-4::obj-32" : [ "amount", "amount", 0 ]
		}
,
		"dependency_cache" : [ 			{
				"name" : "rdp_gl_blur.model.maxpat",
