...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					"annotation" : "interface for kinectmask",
					"args" : [ "#1" ],
					"bgmode" : 0,
					"border" : 0,
					"clickthrough" : 0,
					...
					"lockeddragscroll" : 0,
					"maxclass" : "bpatcher",
					"name" : "rdp_kinectmask.view.maxpat",
					"numinlets" : 1,
					"numoutlets" : 1,
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "" ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 55.0, 214.0, 147.0, 22.0 ],
					"style" : "",
					"text" : "rdp_kinectmask.model #1"
				}
...
, 			{
		...
		"parameters" : 		{
			"obj-4::obj-32" : [ "camera_tilt", "Tilt", 0 ]
		}
,
		"dependency_cache" : [ 			{
				"name" : "rdp_kinectmask.model.maxpat",
