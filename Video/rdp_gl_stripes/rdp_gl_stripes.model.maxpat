...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 266.0, 208.5, 87.0, 22.0 ],
					"style" : "",
					"text" : "prepend angle"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 165.0, 208.5, 87.0, 22.0 ],
					"style" : "",
					"text" : "prepend origin"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 70.0, 208.5, 89.0, 22.0 ],
					"style" : "",
					"text" : "prepend mirror"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 23.5, 120.5, 36.0, 22.0 ],
					"style" : "",
					"text" : "j.in 1"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 23.5, 349.0, 30.0, 30.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 23.5, 317.0, 153.0, 22.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 23.5, 77.0, 30.0, 30.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 48.0, 7.0, 209.0, 29.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 338.0, 209.0, 191.0, 29.0 ],
					"style" : "",
					"text" : "rdp_gl_stripe",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 48.0, 36.0, 206.0, 19.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 348.338348, 230.0, 190.957382, 19.0 ],
					"style" : "",
					"text" : "A model for stripes",
					"textcolor" : [ 0.4, 0.4, 0.4, 1.0 ],
					"varname" : "description"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 5.0, 7.0, 43.0, 42.5 ],
					"presentation" : 1,
					"presentation_rect" : [ 301.0, 209.0, 40.0, 40.875 ],
					"varname" : "logo"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 256.0, 317.0, 290.0, 22.0 ],
					"style" : "",
...
,
					"patching_rect" : [ 455.0, 208.5, 83.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 42.0, 250.0, 92.0, 22.0 ],
					"style" : "",
					"text" : "prepend param"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 23.5, 281.0, 223.0, 22.0 ],
					"style" : "",
					"text" : "jit.gl.slab Jamoma @file v001.stripes.jxs"
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 79.5, 239.75, 51.5, 239.75 ],
					"source" : [ "obj-10", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 174.5, 239.75, 51.5, 239.75 ],
					"source" : [ "obj-11", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 275.5, 239.75, 51.5, 239.75 ],
					"source" : [ "obj-14", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 368.5, 239.75, 51.5, 239.75 ],
					"source" : [ "obj-15", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 464.5, 277.0, 33.0, 277.0 ],
					"source" : [ "obj-22", 0 ]
				}
