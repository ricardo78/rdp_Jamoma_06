...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 121.0, 207.0, 30.0, 30.0 ],
					"presentation_rect" : [ 87.0, 207.0, 0.0, 0.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 17.0, 179.0, 123.0, 22.0 ],
					"style" : "",
					"text" : "rdp_gl_hap.model #1"
				}
...
, 			{
		...
		"dependency_cache" : [ 			{
				"name" : "rdp_gl_hap.model.maxpat",
				"bootpath" : "~/Documents/Github_Development_Library/rdp_Jamoma_06/Video/rdp_gl_hap",
				"type" : "JSON",
				"implicit" : 1
			}
, 			{
