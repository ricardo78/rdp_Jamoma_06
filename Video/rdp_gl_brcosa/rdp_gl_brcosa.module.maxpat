...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"presentation_rect" : [ 89.0, 210.0, 0.0, 0.0 ],
					"style" : ""
				}
...
, 			{
		...
		"parameters" : 		{
			"obj-4::obj-16" : [ "Alpha", "Alpha", 0 ],
			"obj-4::obj-15" : [ "Saturation", "Saturation", 0 ],
			"obj-4::obj-14" : [ "Brightness", "Brightness", 0 ],
			"obj-4::obj-32" : [ "contrast", "Contrast", 0 ]
		}
,
		"dependency_cache" : [ 			{
				"name" : "rdp_gl_brcosa.model.maxpat",
				"bootpath" : "~/Documents/Github_Development_Library/rdp_Jamoma_06/Video/rdp_gl_brcosa",
				"type" : "JSON",
				"implicit" : 1
			}
, 			{
