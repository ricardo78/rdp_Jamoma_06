...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 41.5, 319.0, 415.0, 22.0 ],
					"style" : "",
					"text" : "jit.gl.slab Jamoma_Render_Window @file cf.radialblur.jxs @colormode uyvy"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 99.0, 260.0, 89.0, 21.0 ],
					"style" : "",
					"text" : "prepend param"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 41.5, 124.5, 36.0, 22.0 ],
					"style" : "",
					"text" : "j.in 1"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 41.5, 387.0, 30.0, 30.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 41.5, 355.0, 153.0, 22.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 41.5, 81.0, 30.0, 30.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 66.0, 11.0, 209.0, 29.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 542.0, 324.0, 191.0, 29.0 ],
					"style" : "",
					"text" : "rdp_gl_radialblur",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 66.0, 42.0, 206.0, 19.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 552.338379, 345.0, 190.957382, 19.0 ],
					"style" : "",
					"text" : "A model for radialblur",
					"textcolor" : [ 0.4, 0.4, 0.4, 1.0 ],
					"varname" : "description"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 23.0, 11.0, 43.0, 42.5 ],
					"presentation" : 1,
					"presentation_rect" : [ 505.0, 324.0, 40.0, 40.875 ],
					"varname" : "logo"
				}
...
,
					"patching_rect" : [ 264.5, 228.0, 83.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
