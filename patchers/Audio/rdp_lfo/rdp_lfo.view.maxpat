...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 462.0, 566.5, 258.0, 19.0 ],
					"presentation_rect" : [ 463.0, 569.0, 0.0, 0.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 727.0, 565.0, 88.0, 22.0 ],
					"style" : "",
					"text" : "j.remote range"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 727.0, 525.0, 86.0, 22.0 ],
					"style" : "",
					"text" : "j.remote value"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 462.0, 525.0, 258.0, 19.0 ],
					"style" : ""
				}
...
,
					"patching_rect" : [ 18.0, 116.88562, 50.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "float" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 529.5, 403.0, 44.0, 45.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 240.97229, 252.0, 44.0, 45.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "float" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 529.5, 346.0, 44.0, 45.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 165.931107, 252.0, 44.0, 45.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "float" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 529.5, 287.0, 44.0, 45.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 90.889931, 252.0, 44.0, 45.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 610.0, 418.0, 87.0, 22.0 ],
					"style" : "",
					"text" : "j.remote alpha"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 610.0, 353.5, 110.0, 22.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 610.0, 295.0, 113.0, 22.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 610.0, 231.0, 100.0, 22.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "float" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 529.5, 227.0, 44.0, 45.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 15.848755, 252.0, 44.0, 45.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 18.0, 26.38562, 300.0, 70.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 5.0, 229.5, 300.0, 70.0 ],
					"text" : "/no_model_address",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 18.0, 190.0, 205.0, 22.0 ],
					"style" : "",
					"text" : "j.view @description \"interface for lfo\""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 568.0, 10.0, 99.0, 22.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "int", "int" ],
					"patching_rect" : [ 482.0, 70.0, 79.199997, 22.0 ],
					"style" : "",
					"text" : "unpack i i"
				}
...
,
					"patching_rect" : [ 482.0, 42.0, 105.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1263.0, 298.0, 50.0, 22.0 ],
					"style" : "",
					"text" : "0"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 1186.0, 287.0, 49.339844, 19.171875 ],
					"presentation" : 1,
					"presentation_rect" : [ 131.0, 59.0, 49.339844, 19.171875 ],
					"rounded" : 8.0,
					"style" : "",
					"text" : "normal",
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 1046.099976, 160.0, 56.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 284.0, 102.0, 56.0, 20.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1301.0, 135.0, 150.0, 20.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1242.0, 101.0, 150.0, 20.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 1217.0, 100.0, 20.0, 20.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 1217.0, 187.0, 127.0, 22.0 ],
					"style" : "",
					"text" : "transport"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 1252.0, 135.0, 45.0, 45.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 1617.0, 164.0, 149.0, 142.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1280.0, 455.0, 50.0, 22.0 ],
					"style" : "",
					"text" : "2."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1199.0, 425.0, 50.0, 22.0 ],
					"style" : "",
					"text" : "2."
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 1062.5, 352.0, 59.0, 82.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 129.0, 123.0, 20.0, 80.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 1082.0, 113.0, 20.0, 140.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 286.0, 59.0, 20.0, 129.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 1052.0, 113.0, 20.0, 140.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 262.0, 59.0, 20.0, 129.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 952.0, 231.0, 74.0, 22.0 ],
					"style" : "",
					"text" : "prepend set"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 952.0, 260.0, 41.0, 114.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 313.0, 59.0, 41.0, 129.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 810.0, 90.0, 20.0, 140.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 271.0, 44.0, 20.0, 129.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 710.0, 81.0, 20.0, 140.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 247.0, 44.0, 20.0, 129.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 827.0, 449.0, 76.0, 22.0 ],
					"style" : "",
					"text" : "slide~ 20. 0."
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 827.0, 475.0, 112.0, 80.0 ],
					"presentation" : 1,
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 1226.5, 127.0, 1261.5, 127.0 ],
					"source" : [ "obj-7", 0 ]
				}
