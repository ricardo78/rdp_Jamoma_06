...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 40.5, 158.5, 36.0, 22.0 ],
					"style" : "",
					"text" : "j.in 1"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 40.5, 335.0, 30.0, 30.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 40.5, 303.0, 153.0, 22.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 40.5, 115.0, 30.0, 30.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 65.0, 45.0, 209.0, 29.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 65.0, 74.0, 206.0, 19.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 22.0, 45.0, 43.0, 42.5 ],
					"presentation" : 1,
					"presentation_rect" : [ 252.0, 166.0, 40.0, 40.875 ],
					"varname" : "logo"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 230.0, 303.0, 290.0, 22.0 ],
					"style" : "",
...
,
					"patching_rect" : [ 151.0, 212.0, 83.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 63.5, 212.0, 78.0, 22.0 ],
					"style" : "",
					"text" : "prepend amt"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 40.5, 256.0, 180.0, 22.0 ],
					"style" : "",
					"text" : "jit.gl.pix Jamoma @gen bleachit"
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 73.0, 244.5, 50.0, 244.5 ],
					"source" : [ "obj-2", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 160.5, 244.5, 50.0, 244.5 ],
					"source" : [ "obj-5", 0 ]
				}
...
, 			{
		...
		"dependency_cache" : [ 			{
				"name" : "bleachit.genjit",
				"bootpath" : "~/Documents/Github_Development_Library/rdp_Jamoma_06/patchers/Video/rdp_gl_bleach",
				"type" : "gJIT",
				"implicit" : 1
			}
, 			{
