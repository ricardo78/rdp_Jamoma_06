...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 112.0, 150.0, 30.0, 30.0 ],
					"presentation_rect" : [ 27.0, 149.0, 0.0, 0.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 7.0, 118.0, 124.0, 22.0 ],
					"style" : "",
					"text" : "rdp_gl_rota.model #1"
				}
...
, 			{
		...
		"dependency_cache" : [ 			{
				"name" : "rdp_gl_rota.model.maxpat",
				"bootpath" : "~/Documents/Github_Development_Library/rdp_Jamoma_06/Video/rdp_gl_rota",
				"type" : "JSON",
				"implicit" : 1
			}
, 			{
