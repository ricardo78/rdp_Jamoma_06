...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 237.0, 96.5, 453.0, 35.0 ],
					"style" : "",
					"text" : "j.parameter zoom @type decimal @clipmode none @ramp/drive max @dataspace none",
					"varname" : "radial[1]"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 0,
					"numoutlets" : 0,
					"patching_rect" : [ 302.0, 300.0, 114.0, 22.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 76.0, 161.0, 36.0, 22.0 ],
					"style" : "",
					"text" : "j.in 1"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 76.0, 468.0, 30.0, 30.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 76.0, 436.0, 153.0, 22.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 76.0, 117.5, 30.0, 30.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 302.0, 449.0, 30.0, 30.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 108.5, 14.0, 209.0, 29.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 523.0, 538.0, 191.0, 29.0 ],
					"style" : "",
					"text" : "rdp_gl_radialZoom",
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 65.5, 14.0, 43.0, 42.5 ],
					"presentation" : 1,
					"presentation_rect" : [ 486.0, 538.0, 40.0, 40.875 ],
					"varname" : "logo"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 302.0, 412.0, 307.0, 22.0 ],
					"style" : "",
...
,
					"patching_rect" : [ 302.0, 346.0, 83.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 76.0, 387.0, 191.0, 19.0 ],
					"style" : "",
					"text" : "jit.gl.slab Jamoma @file v001.cartopol.jxs"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 262.0, 197.0, 108.0, 19.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 358.0, 178.0, 27.0, 19.0 ],
					"style" : "",
					"text" : "/ 3."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 326.0, 178.0, 27.0, 19.0 ],
					"style" : "",
					"text" : "/ 3."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_gl_texture", "" ],
					"patching_rect" : [ 76.0, 346.0, 180.0, 19.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_gl_texture", "" ],
					"patching_rect" : [ 76.0, 317.0, 180.0, 19.0 ],
					"style" : "",
					"text" : "jit.gl.slab Jamoma @file cf.gaussian.2p.jxs"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_gl_texture", "" ],
					"patching_rect" : [ 76.0, 287.0, 180.0, 19.0 ],
					"style" : "",
					"text" : "jit.gl.slab Jamoma @file cf.gaussian.2p.jxs"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_gl_texture", "" ],
					"patching_rect" : [ 76.0, 252.0, 180.0, 19.0 ],
					"style" : "",
					"text" : "jit.gl.slab Jamoma @file cf.gaussian.2p.jxs"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 148.0, 197.0, 108.0, 19.0 ],
					"style" : "",
					"text" : "pak param width 0. 0."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 179.0, 56.0, 478.0, 22.0 ],
					"style" : "",
					"text" : "j.parameter radial @type decimal @clipmode none @ramp/drive max @dataspace none",
					"varname" : "radial"
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 271.5, 280.0, 85.5, 280.0 ],
					"source" : [ "obj-14", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 271.5, 340.0, 85.5, 340.0 ],
					"source" : [ "obj-14", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 157.5, 245.0, 85.5, 245.0 ],
					"source" : [ "obj-8", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 157.5, 310.0, 85.5, 310.0 ],
					"source" : [ "obj-8", 0 ]
				}
...
, 			{
		...
		"parameters" : 		{
			"obj-9::obj-167" : [ "live.text[6]", "live.text", 0 ],
			"obj-9::obj-166" : [ "live.text[5]", "live.text", 0 ],
			"obj-9::obj-165" : [ "live.text[4]", "live.text", 0 ],
			"obj-9::obj-164" : [ "live.text[3]", "live.text", 0 ],
			"obj-9::obj-163" : [ "live.text[2]", "live.text", 0 ],
			"obj-9::obj-162" : [ "live.text[1]", "live.text", 0 ],
			"obj-9::obj-161" : [ "live.text", "live.text", 0 ],
			"obj-9::obj-176" : [ "live.text[15]", "live.text", 0 ],
			"obj-9::obj-175" : [ "live.text[14]", "live.text", 0 ],
			"obj-9::obj-174" : [ "live.text[13]", "live.text", 0 ],
			"obj-9::obj-173" : [ "live.text[12]", "live.text", 0 ],
			"obj-9::obj-172" : [ "live.text[11]", "live.text", 0 ],
			"obj-9::obj-171" : [ "live.text[10]", "live.text", 0 ],
			"obj-9::obj-170" : [ "live.text[9]", "live.text", 0 ],
			"obj-9::obj-169" : [ "live.text[8]", "live.text", 0 ],
			"obj-9::obj-168" : [ "live.text[7]", "live.text", 0 ]
		}
,
		"dependency_cache" : [ 			{
				"name" : "RDPJamomaLogo.png",
