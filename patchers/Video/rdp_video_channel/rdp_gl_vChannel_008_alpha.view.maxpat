...
, 							{
								"box" : 								{
									...
									"saved_attribute_attributes" : 									{
										"valueof" : 										{
											"parameter_longname" : "reset_loop[1]",
...
, 							{
								"box" : 								{
									...
									"saved_attribute_attributes" : 									{
										"valueof" : 										{
											"parameter_longname" : "read_files[1]",
...
, 							{
								"box" : 								{
									...
									"saved_attribute_attributes" : 									{
										"valueof" : 										{
											"parameter_longname" : "loop_report[1]",
								...
								"box" : 								{
									...
									"saved_attribute_attributes" : 									{
										"valueof" : 										{
											...
											"parameter_longname" : "loop_mode[1]",
...
, 							{
								"box" : 								{
									...
									"saved_attribute_attributes" : 									{
										"valueof" : 										{
											"parameter_longname" : "framereport[1]",
...
,
					"patching_rect" : [ 2.0, 120.5, 300.0, 105.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 299.0, 19.5, 300.0, 105.0 ],
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"lockeddragscroll" : 0,
					"maxclass" : "bpatcher",
					"name" : "rdp_gl_glue.view.maxpat",
					"numinlets" : 1,
					"numoutlets" : 1,
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "" ],
					"patching_rect" : [ 747.0, 178.0, 300.0, 70.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 299.0, 126.5, 300.0, 70.0 ],
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 0.0, 342.5, 300.0, 70.0 ],
					"viewvisibility" : 1
				}
...
,
					...
					"presentation" : 1,
					"presentation_rect" : [ 0.0, 19.5, 300.0, 105.0 ],
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 299.0, 270.5, 300.0, 70.0 ],
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 0.0, 198.5, 300.0, 70.0 ],
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 0.0, 270.5, 300.0, 70.0 ],
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 0.0, 126.5, 300.0, 70.0 ],
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 299.0, 198.5, 300.0, 70.0 ],
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 299.0, 342.5, 300.0, 70.0 ],
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 0.0, -0.5, 600.0, 420.0 ],
...
, 			{
		...
		"parameters" : 		{
			...
			"obj-7::obj-15" : [ "play[1]", "Play", 0 ],
			"obj-6::obj-6" : [ "xfade", "Xfade", 0 ],
			"obj-11::obj-105" : [ "reset_loop", "Reset loop", 0 ],
			"obj-11::obj-14" : [ "read_files", "Read files", 0 ],
			"obj-7::obj-14" : [ "read_files[1]", "Read files", 0 ],
			"obj-12::obj-2" : [ "Alpha", "Alpha", 0 ],
			"obj-36::obj-32" : [ "slide_up", "Up", 0 ],
			"obj-7::obj-18" : [ "loop_mode[1]", "Loop mode", 0 ],
			"obj-6::obj-32" : [ "threshold", "Threshold", 0 ],
			...
			"obj-7::obj-19" : [ "loop_report[1]", "Loop report", 0 ],
			"obj-12::obj-15" : [ "Layer", "Layer", 0 ],
			"obj-7::obj-26" : [ "framereport[1]", "Frame report", 0 ],
