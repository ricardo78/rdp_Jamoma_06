...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 164.0, 251.0, 30.0, 30.0 ],
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "" ],
					"patching_rect" : [ 29.0, 20.0, 150.0, 70.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 55.0, 251.0, 30.0, 30.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 55.0, 175.0, 30.0, 30.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 55.0, 214.0, 128.0, 22.0 ],
					"style" : "",
					"text" : "rdp_gl_slide.model #1"
				}
...
, 			{
		...
		"parameters" : 		{
			"obj-4::obj-32" : [ "slide_up", "Up", 0 ],
			"obj-4::obj-2" : [ "slide_down", "Down", 0 ]
		}
,
		"dependency_cache" : [ 			{
				"name" : "rdp_gl_slide.model.maxpat",
				"bootpath" : "~/Documents/Github_Development_Library/rdp_Jamoma_06/Video/rdp_gl_slide",
				"type" : "JSON",
				"implicit" : 1
			}
, 			{
