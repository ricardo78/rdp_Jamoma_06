...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					"annotation" : "interface controling cornerpin",
					"args" : [ "#1" ],
					"bgmode" : 0,
					"border" : 0,
					"clickthrough" : 0,
					...
					"lockeddragscroll" : 0,
					"maxclass" : "bpatcher",
					"name" : "rdp_gl_cornerpin.view.maxpat",
					"numinlets" : 1,
					"numoutlets" : 1,
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "" ],
...
, 			{
				"box" : 				{
					"annotation" : "a model for cornerpin",
					"id" : "obj-1",
					"maxclass" : "newobj",
					"numinlets" : 1,
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 17.0, 179.0, 153.0, 22.0 ],
					"style" : "",
					"text" : "rdp_gl_cornerpin.model #1"
				}
...
, 			{
		...
		"dependency_cache" : [ 			{
				"name" : "rdp_gl_cornerpin.model.maxpat",
				"bootpath" : "~/Documents/Github_Development_Library/rdp_Jamoma_06/Video/rdp_gl_cornerpin",
				"type" : "JSON",
				"implicit" : 1
			}
, 			{
