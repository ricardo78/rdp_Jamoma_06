...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 132.0, 207.0, 30.0, 30.0 ],
					"presentation_rect" : [ 77.0, 209.0, 0.0, 0.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 17.0, 179.0, 134.0, 22.0 ],
					"style" : "",
					"text" : "rdp_gl_mirror.model #1"
				}
...
, 			{
		...
		"parameters" : 		{
			"obj-4::obj-13" : [ "offsety", "Offset Y", 0 ],
			"obj-4::obj-14" : [ "offsetx", "Offset X", 0 ],
			"obj-4::obj-12" : [ "originy", "Origin Y", 0 ],
			"obj-4::obj-32" : [ "originx", "Origin X", 0 ]
		}
,
		"dependency_cache" : [ 			{
				"name" : "rdp_gl_mirror.model.maxpat",
				"bootpath" : "~/Documents/Github_Development_Library/rdp_Jamoma_06/Video/rdp_gl_mirror",
				"type" : "JSON",
				"implicit" : 1
			}
, 			{
