...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 98.0, 244.5, 98.0, 22.0 ],
					"style" : "",
					"text" : "prepend amount"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 114.174561, 327.5, 91.825439, 22.0 ],
					"style" : "",
					"text" : "prepend color"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 208.0, 221.0, 311.0, 89.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 37.0, 125.5, 36.0, 22.0 ],
					"style" : "",
					"text" : "j.in 1"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 37.0, 487.0, 30.0, 30.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 37.0, 455.0, 153.0, 22.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 37.0, 82.0, 30.0, 30.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 229.0, 487.0, 30.0, 30.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 57.0, 12.0, 209.0, 29.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 668.0, 230.0, 191.0, 29.0 ],
					"style" : "",
					"text" : "rdp_gl_tint",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 57.0, 41.0, 206.0, 19.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 678.338379, 251.0, 190.957382, 19.0 ],
					"style" : "",
					"text" : "A model for colorpimping",
					"textcolor" : [ 0.4, 0.4, 0.4, 1.0 ],
					"varname" : "description"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 14.0, 12.0, 43.0, 42.5 ],
					"presentation" : 1,
					"presentation_rect" : [ 631.0, 230.0, 40.0, 40.875 ],
					"varname" : "logo"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 229.0, 455.0, 327.0, 22.0 ],
					"style" : "",
					"text" : "j.model @tags color @description \"a model for tinting color\""
				}
...
,
					"patching_rect" : [ 534.0, 173.5, 83.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 0,
					"numoutlets" : 0,
					"patching_rect" : [ 473.0, 415.0, 124.0, 22.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 37.0, 415.0, 421.0, 22.0 ],
					"style" : "",
					"text" : "jit.gl.slab Jamoma_Render_Window @file v001.tintlight.jxs @colormode uyvy"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 98.0, 358.0, 92.0, 22.0 ],
					"style" : "",
					"text" : "prepend param"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 98.0, 170.0, 421.0, 49.0 ],
					"style" : "",
					"text" : "j.parameter amount @type decimal @range -50 50 @clipmode both @ramp/drive max @ramp/function linear @dataspace none @priority 1 @default 1 @tags color @description",
					"varname" : "amount"
				}
		...
		"lines" : [ 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 107.5, 397.0, 46.5, 397.0 ],
					"source" : [ "obj-10", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 543.5, 404.75, 46.5, 404.75 ],
					"source" : [ "obj-22", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 217.5, 317.0, 123.674561, 317.0 ],
					"source" : [ "obj-74", 0 ]
				}
