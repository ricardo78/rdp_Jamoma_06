...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "signal", "" ],
					"patching_rect" : [ 123.0, 400.0, 52.0, 22.0 ],
					"style" : "",
					"text" : "j.out~ R"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "signal", "" ],
					"patching_rect" : [ 24.0, 400.0, 50.0, 22.0 ],
					"style" : "",
					"text" : "j.out~ L"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "signal", "" ],
					"patching_rect" : [ 123.0, 274.0, 45.0, 22.0 ],
					"style" : "",
					"text" : "j.in~ R"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "signal", "" ],
					"patching_rect" : [ 24.0, 274.0, 43.0, 22.0 ],
					"style" : "",
					"text" : "j.in~ L"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 123.0, 442.0, 25.0, 25.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 24.0, 442.0, 25.0, 25.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 123.0, 235.0, 25.0, 25.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 63.0, 49.0, 209.0, 29.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 310.0, 74.0, 191.0, 29.0 ],
					"style" : "",
					"text" : "rdp_reverb",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 63.0, 78.0, 206.0, 19.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 320.338348, 95.0, 190.957382, 19.0 ],
					"style" : "",
					"text" : "A model for reverb",
					"textcolor" : [ 0.4, 0.4, 0.4, 1.0 ],
					"varname" : "description"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 20.0, 49.0, 43.0, 42.5 ],
					"presentation" : 1,
					"presentation_rect" : [ 273.0, 74.0, 40.0, 40.875 ],
					"varname" : "logo"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 186.0, 442.0, 25.0, 25.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 186.0, 400.0, 308.0, 22.0 ],
					"style" : "",
					"text" : "j.model @tags reverb @description \"a model for reverb\""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 284.0, 312.0, 44.0, 22.0 ],
					"style" : "",
					"text" : "dry $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 334.0, 312.0, 46.0, 22.0 ],
					"style" : "",
					"text" : "wet $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 569.0, 312.0, 55.0, 22.0 ],
					"style" : "",
					"text" : "width $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 483.0, 312.0, 73.0, 22.0 ],
					"style" : "",
					"text" : "damping $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 392.0, 312.0, 76.0, 22.0 ],
					"style" : "",
					"text" : "roomsize $1"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 24.0, 345.0, 118.0, 22.0 ],
					"style" : "",
					"text" : "freeverb~"
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 492.5, 339.0, 33.5, 339.0 ],
					"source" : [ "obj-10", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 293.5, 339.0, 33.5, 339.0 ],
					"source" : [ "obj-11", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 401.5, 339.0, 33.5, 339.0 ],
					"source" : [ "obj-15", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 578.5, 339.0, 33.5, 339.0 ],
					"source" : [ "obj-8", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 343.5, 339.0, 33.5, 339.0 ],
					"source" : [ "obj-9", 0 ]
				}
